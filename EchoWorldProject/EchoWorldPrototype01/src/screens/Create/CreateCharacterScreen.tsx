  ...
  const renderStep3 = () => (
    <View style={styles.stepContent}>
      ...
      <View style={styles.lifeStageContainerVertical}>
        <TouchableOpacity
          style={[styles.lifeStageOptionVertical, draft.lifeStage === 'adolescent' && styles.lifeStageSelectedVertical]}
          onPress={() => handleSelectLifeStage('adolescent')}
        >
          <Text style={[styles.lifeStageTextVertical, draft.lifeStage === 'adolescent' && styles.lifeStageTextSelectedVertical]}>
            少年期
          </Text>
          <Text style={styles.lifeStageAgeVertical}>12-17岁</Text>
          <Text style={styles.lifeStagePersonalityVertical}>天真活泼，充满好奇心</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[styles.lifeStageOptionVertical, draft.lifeStage === 'middle_aged' && styles.lifeStageSelectedVertical]}
          onPress={() => handleSelectLifeStage('middle_aged')}
        >
          <Text style={[styles.lifeStageTextVertical, draft.lifeStage === 'middle_aged' && styles.lifeStageTextSelectedVertical]}>
            中老年
          </Text>
          <Text style={styles.lifeStageAgeVertical}>56-70岁</Text>
          <Text style={styles.lifeStagePersonalityVertical}>阅历丰富，心态平和</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
